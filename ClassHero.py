...
class Hero():
    ...
    def __init__(self, position, faceRight):
        idleSpriteSheet = SpriteSheet(IDLE_SPRITE, idleSprites)
        runSpriteSheet = SpriteSheet(RUN_SPRITE, runSprites)
        attackSpriteSheet = SpriteSheet(ATTACK_SPRITE, attackSprites)
